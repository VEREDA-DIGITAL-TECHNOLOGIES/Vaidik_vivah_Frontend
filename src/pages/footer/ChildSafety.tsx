    ...
    return (
        <div className="flex flex-col ">
            <div className="bg-[#fac5d6] text-center px-6 py-6 md:p-24 space-y-8">
                ...
                <h1 className=" text-2xl md:text-4xl font-semibold">Ved Vivah Child Safety Policy
                </h1>
            ...
            <div className="px-4 py-4 flex md:flex-row flex-col gap-7">
                ...
                <div className=" flex flex-col items-start md:pr-10">
                    ...
                    <h4>For any concerns related to child safety, please reach out to our Child Safety Team at <span className="font-semibold underline">info@vedvivah.com</span> </h4>
