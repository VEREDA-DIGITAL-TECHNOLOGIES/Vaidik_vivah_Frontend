      ...
      <div className="flex flex-col md:flex-row flex-grow gap-5 p-4 md:p-16">
        ...
        <div className=" ">
          <h1 className="text-md font-bold pb-4">
            Ved Vivah Terms and Conditions of Use
          </h1>
          <p className="pb-4">
            Welcome to Ved Vivah’s Terms and Conditions of Use (these “Terms”).
            This is a contract between you and the Ved Vivah Global Services (as
            defined further below) and we want you to know yours and our rights
            before you use the Ved Vivah website or application (“Ved Vivah” or the
          ...
          <p className="pb-4">
            ...
            the Initial Term at Ved Vivah’s then-current fee for such services,
          ...
          <p className="pb-4">
            ...
            provisions governing how claims that you and Ved Vivah Global Services
          ...
          <h3 className="text-md font-bold ">1. VEDVIVAH RULES </h3>
          <p className="pb-4">
          ...
          <p className="pb-4">
            You’ll have great fun on Ved Vivah, but if you feel the need to leave,
          ...
          <ul className="list-decimal pl-4  pb-4">
            ...
            <li>
              content that the Ved Vivah Global Services provides (including,
              without limitation, database(s) and/or software) (“Our Content”).
            </li>
          </ul>
          <h3 className="text-md font-bold">
            {" "}
            There is certain content we can’t allow on Ved Vivah
          </h3>
          <p className="pb-4">
          ...
          <p className="pb-4">
            ...
            on Ved Vivah, but we have to impose restrictions on certain content
            which:
          </p>
          <ul className="list-disc pl-4">
            ...
            <li>
              ...
              whether from Ved Vivah or otherwise; or
            </li>
          ...
          <p className="pb-4">
            As Ved Vivah is a public community, Your Content will be visible to
            ...
            content from other Ved Vivah Users). By uploading Your Content on
            Ved Vivah, you represent and warrant to us that you have all necessary
          ...
          <p className="pb-4">
            ...
            members or third parties outside of Ved Vivah, you authorise us to act
            ...
            taken and used by third parties outside of Ved Vivah.
          </p>
          <h3>Member Content </h3>
          <p className="pb-4">
            Other members of Ved Vivah will also share content via the App or
          ...
          <p className="pb-4">
            ...
            Content, and you may only use other Ved Vivah users’ personal
            information to the extent that your use of it matches Ved Vivah’s
          ...
          <p className="pb-4">
            ...
            Ved Vivah. Well, it belongs to us! Any other text, content, graphics,
            user interfaces, trademarks, logos, sounds, artwork, and other
            intellectual property appearing on Ved Vivah, as well as the Ved Vivah
          ...
          <ul className="list-decimal pl-4 pb-4">
            ...
            <li>use your real name and real age in creating your Ved Vivah account and on your profile; and
            </li>
          ...
          <p className="pb-4">
            IN CERTAIN CIRCUMSTANCES, SUCH AS IN RESPONSE TO MEMBER-GENERATED OR PRESS REPORTS OF SUSPECTED MISCONDUCT, THE VEDVIVAH GLOBAL SERVICES MAY INVESTIGATE WHETHER A MEMBER HAS A CRIMINAL HISTORY, WHICH MAY, DEPENDING ON THE CIRCUMSTANCES, INCLUDE SEARCHING SEX OFFENDER REGISTRIES OR OTHER PUBLIC RECORDS. IF SUCH INVESTIGATIONS IDENTIFY A PERSON WITH A CRIMINAL CONVICTION, THE VEDVIVAH GLOBAL SERVICES MAY USE AVAILABLE INFORMATION TO DETERMINE WHETHER THE PERSON IDENTIFIED BY THE INVESTIGATION IS THE SAME PERSON AS THE MEMBER ABOUT WHOM THE INVESTIGATION WAS CONDUCTED. FOLLOWING ANY SUCH INVESTIGATION, WITH RESPECT TO ANY MEMBER THAT THE VEDVIVAH GLOBAL SERVICES REASONABLY BELIEVES TO HAVE BEEN CONVICTED OF A SEX OFFENCE (SUCH AS SEXUAL ASSAULT OR SEXUAL HARASSMENT, AND INCLUDING ANY REGISTERED SEX OFFENDERS), OR A CONVICTION FOR HUMAN TRAFFICKING, STALKING, KIDNAPPING, CHILD ABUSE, DOMESTIC ABUSE, MURDER, HATE CRIMES, OR TERRORISM OR VIOLENT EXTREMISM, THE VEDVIVAH GLOBAL SERVICES MAY TAKE STEPS TO BLOCK THAT PERSON FROM USING THE SERVICE AND COMMUNICATING WITH OTHER MEMBERS OVER THE PLATFORM. THE VEDVIVAH GLOBAL SERVICES RESERVES THE RIGHT TO BLOCK MEMBERS FOR OTHER OFFENCES, OR FOR OTHER VIOLATIONS OF THESE TERMS, OR FOR OTHER REASONS IN THEIR SOLE DISCRETION. CRIMINAL BACKGROUND INVESTIGATIONS, WHEN CONDUCTED, ARE NOT TYPICALLY UPDATED BY THE VEDVIVAH GLOBAL SERVICES. ADDITIONALLY, WHILE INVESTIGATIONS FOR CRIMINAL HISTORIES MAY BE CONDUCTED ON SOME MEMBERS, THEY ARE NOT FOOLPROOF AND MOST MEMBERS ARE NOT EXPECTED TO BE SUBJECT TO ANY FORM OF CHECK FOR CRIMINAL HISTORIES. ANY INVESTIGATIONS FOR CRIMINAL HISTORIES MAY GIVE MEMBERS A FALSE SENSE OF SECURITY. THE CHECKS FOR CRIMINAL HISTORIES THAT MAY BE CONDUCTED BY THE VEDVIVAH GLOBAL SERVICES ARE NOT A PERFECT SAFETY SOLUTION. CRIMINALS MAY CIRCUMVENT EVEN THE MOST SOPHISTICATED SEARCH TECHNOLOGY. NOT ALL CRIMINAL RECORDS ARE PUBLIC IN ALL STATES AND NOT ALL DATABASES ARE UP TO DATE. ONLY PUBLICLY AVAILABLE CONVICTIONS ARE INCLUDED IN CHECKS, AND CHECKS DO NOT COVER OTHER TYPES OF CONVICTIONS OR ARRESTS OR ANY CONVICTIONS FROM FOREIGN COUNTRIES.
          </p>
          <p className="pb-4">
            You agree to, and hereby do, release Ved Vivah Global Services and its successors from any claims, demands, losses, damages, rights, and actions of any kind, including personal injuries, death and property damage, that either directly or indirectly arises from your interactions with or conduct of other users of the App or Site.
          ...
          <p>For information about how the Ved Vivah Global Services collects, uses, and shares your personal data, please check out our Privacy Policy. By using Ved Vivah, you acknowledge that we may use such data in accordance with our Privacy Policy.
          </p>
          <p>
            Generally.
          </p>
          <p className="pb-4">Ved Vivah may offer products and services for purchase on App (“In-App Purchase”). If you choose to make an In-App Purchase, you acknowledge and agree that additional terms, disclosed to you at the point of purchase, may apply, and that such additional terms are incorporated herein by reference.
          </p>
          ...
          <p className="pb-4">In addition to cancelling, eligible subscribers must request a refund to receive one. If you subscribed using your Apple ID, refunds are handled by Apple, not Ved Vivah. To request a refund, go to iTunes, click on your Apple ID, select “Purchase history,” find the transaction and hit “Report Problem”. You can also submit a request at Apple Support.
          </p>
          <p className="pb-4">For all other purchases: please contact customer support with your order number (you can find the order number in the order confirmation email, or if you purchased from the Google Play Store by logging in to Google Wallet). You may also mail or deliver a signed and dated notice which states that you, the buyer, are cancelling this agreement, or words of similar effect. Please also include the email address or mobile number associated with your account along with your order number. This notice shall be emailed to: info@VEDVIVAH.au.
          </p>
          <p className="pb-4">
            The payments required under this Section 5 do not include any Goods and Services Tax (GST) that may be due in connection with the subscription-based services provided under these Terms. If Ved Vivah determines it has a legal obligation to collect a GST from you in connection with these Terms, Ved Vivah will collect such GST in addition to the payments required under this Section 5. If any subscription-based services, or payments for any subscription-based services, under these Terms are subject to any GST in any jurisdiction and you have not remitted the applicable GST to Ved Vivah, you will be responsible for the payment of such GST and any related penalties or interest to the relevant tax authority. As used herein, “Goods and Services Tax” means any goods and sales or use tax and any other tax measured by goods and sales proceeds that is the functional equivalent of a GST where the applicable taxing jurisdiction does not otherwise impose a sales or use tax.

          </p>
          <h3 className="font-bold text-md">6. VIRTUAL ITEMS </h3>
          <p className="pb-4">At times, you may be able to purchase a limited, personal, non-transferable, non-sublicensable, revocable licence to access special limited-use features from Ved Vivah, referred to here as “Virtual Items”. You can only purchase Virtual Items through Ved Vivah or Ved Vivah’s partners. Virtual Items represent a limited license right governed by this Agreement, and, except as otherwise prohibited by applicable law, no title or ownership in or to Virtual Items is being transferred or assigned to you. This Agreement, and your purchase of Virtual Items, does not constitute the sale of any rights in Virtual Items.
          </p>
          <p className="pb-4">
            Any Virtual Item balance shown in your account does not constitute a real-world balance or reflect any stored value, but instead shows the extent of your licence to access Virtual Items. Virtual Items do not incur fees for non-use. Your licence in Virtual Items will terminate on the earlier of Ved Vivah ceasing provision of services or your account closing or terminating. Ved Vivah may also at times provide Virtual Items as bonuses to, or parts of, paid subscriptions for its services. Your ability to use Virtual Items you have access to in this manner may terminate at the end of each of your subscription periods and your access to Virtual Items may not “roll over” or accumulate through additional subscription periods. Your access to Virtual Items gained through subscriptions may also end if you cancel your subscription.
            Ved Vivah, in its sole discretion, reserves the right to charge fees for the right to access or use Virtual Items and/or may distribute Virtual Items with or without charge. Ved Vivah may manage, regulate, control, modify, or eliminate Virtual Items at any time, including taking actions that may impact the perceived value or purchase price, if applicable, of any Virtual Items and Ved Vivah shall have no liability to you for doing so. You shall not sell, redeem, or otherwise transfer Virtual Items to any person or entity. Virtual Items may only be redeemed through our Services.

          </p>
          <p className="pb-4">
            ALL PURCHASES AND REDEMPTIONS OF VIRTUAL ITEMS MADE THROUGH OUR SERVICES ARE FINAL AND NON-REFUNDABLE. YOU ACKNOWLEDGE THAT VEDVIVAH IS NOT REQUIRED TO PROVIDE A REFUND FOR ANY REASON, AND THAT YOU WILL NOT RECEIVE MONEY OR OTHER COMPENSATION FOR UNUSED VIRTUAL ITEMS WHEN AN ACCOUNT IS CLOSED, WHETHER SUCH CLOSURE WAS VOLUNTARY OR INVOLUNTARY.
          </p>
          <h3>7. PUSH NOTIFICATIONS; LOCATION-BASED FEATURES</h3>
          <p className="pb-4">We may provide you with emails, text messages, push notifications, alerts and other messages related to the App and/or the Ved Vivah services, such as enhancements, offers, products, events, and other promotions. After downloading the App, you may be asked to accept or deny push notifications/alerts. If you deny, you will not receive any push notifications/alerts. If you accept, push notifications/alerts will be automatically sent to you. If you no longer wish to receive push notifications/alerts from the App, you may opt out by changing your notification settings on your mobile device. With respect to other types of messaging or communications, such as emails, text messages, etc., you can unsubscribe or opt out by either following the specific instructions included in such communications.
          </p>
          ...
          <p className="pb-4">
            ADDITIONALLY, WE DO NOT MAKE ANY WARRANTIES THAT THE APP OR Site WILL BE UNINTERRUPTED, SECURE OR ERROR FREE OR THAT YOUR USE OF THE APP OR Site WILL MEET YOUR EXPECTATIONS, OR THAT THE APP, Site, OUR CONTENT, ANY MEMBER CONTENT, OR ANY PORTION THEREOF, IS CORRECT, ACCURATE, OR RELIABLE. YOUR USE OF THE APP OR Site IS AT YOUR OWN RISK. YOU ARE SOLELY RESPONSIBLE FOR YOUR INTERACTIONS WITH OTHER MEMBERS. THE VEDVIVAH GLOBAL SERVICES IS NOT RESPONSIBLE FOR THE CONDUCT OF ANY USER. VEDVIVAH GLOBAL SERVICES DOES NOT CONDUCT CRIMINAL BACKGROUND CHECKS ON ITS MEMBERS.
          </p>
          ...
          <p className="pb-4">All the actions you make and information you post on Ved Vivah remain your responsibility. Therefore, you agree to indemnify, defend, release, and hold us, and our partners, licensors, affiliates, contractors, officers, directors, employees, representatives and agents, harmless, from and against any third-party claims, damages (actual and/or consequential), actions, proceedings, demands, losses, liabilities, costs and expenses (including reasonable legal fees) suffered or reasonably incurred by us arising as a result of, or in connection with:
          </p>
          ...
          <p className="pb-4">
            The foregoing provision does not require you to indemnify Ved Vivah Global Services for any unconscionable commercial practice or any fraud, deception, false promise,
          ...
          <p className="pb-4">
            If you believe any content on Ved Vivah infringes the copyright in a work that you own, please submit a notification alleging such infringement to Ved Vivah Global Services. The Takedown Notice must include the following:
          ...
          <p className="pb-4">Please read the following arbitration agreement in this Section (“Arbitration Agreement”) carefully. Unless you opt out in the manner described in Section 13(10) below, this Arbitration Agreement requires you and Ved Vivah Global Services to resolve disputes by binding arbitration instead of in court, and limits the manner in which we may seek relief from each other.
          </p>
          <ul className="list-decimal pl-4 space-y-4 pb-4">
            <li >When Does This Arbitration Agreement Apply? This Arbitration Agreement applies to any disputes or claims of any kind whatsoever (whether based in contract, tort, statute, regulation, ordinance, fraud, misrepresentation or any other legal or equitable theory) between you and the Ved Vivah Global Services arising out of or relating to the Terms, prior versions of the Terms, your use of our App or Site, or any other aspect of your relationship with Ved Vivah, including claims or disputes arising (but not actually filed in arbitration) before the effective date of these Terms. It requires that, and by entering into these Terms you and Ved Vivah Global Services agree, that such disputes or claims will be resolved by binding arbitration, rather than in court, except that (i) you or Ved Vivah may assert individual claims in small claims court if your claims qualify; and (ii) you or Ved Vivah may seek equitable relief in court for infringement or misuse of intellectual property rights.
            </li>
            <li>Notice of Dispute and Informal Resolution. Before beginning the arbitration process, you and Ved Vivah Global Services agree to first notify one another of the dispute in writing at least 60 days in advance of initiating an arbitration. Notice to Ved Vivah Global Services must be sent by letter, and must provide your name, current email address, mailing address, and telephone number, as well as the name, email address, and telephone number associated with your Ved Vivah account (if different from your current information); and describe the nature of the claim and the specific relief being sought.
            </li>
            <p>You and Ved Vivah agree to meet and confer, via teleconference or videoconference, in a good faith effort to informally resolve any claim or dispute covered by this Arbitration Agreement. If either party is represented by counsel, that counsel may participate in the informal dispute resolution conference. During this process, you may be provided with an offer of judgment. A party defending against a claim may serve on an opposing party an offer to allow judgment on specified terms, with the costs then accrued. If the judgment that the offeree finally obtains is not more favourable than the unaccepted offer, the offeree must pay the costs incurred after the offer was made.
            </p>
            ...
            <li>
              How Do You Start The Arbitration Process? If you and Ved Vivah Global Services are unable to resolve the dispute within 60 days, either party may proceed to file a claim for arbitration. To begin the arbitration process, you or Ved Vivah Global Services must submit notice by certified mail of the claim with an individualised arbitration demand. To be valid, the demand must contain the name of the claiming party (you or Ved Vivah Global Services), your or Ved Vivah Global Services mailing address, the email address or phone number associated with your Ved Vivah account (if applicable), and a detailed description of the dispute and the relief sought. Notice to Ved Vivah Global Services must be submitted.

            </li>
            <li>
              What Are The Rules Of Arbitration? The initiating party must pay all filing fees for the arbitration. Your and Ved Vivah Global Services responsibility to pay other administrative and arbitrator costs will be as set forth in the applicable arbitration provider’s rules, unless the arbitrator determines the claims are frivolous. If a claim is determined to be frivolous, the claimant is responsible for reimbursing the respondent for its portion of all such administrative, hearing, and/or other fees incurred as a result of the frivolous claim.
            ...
            <li>
              Opt-Out. Updates to Ved Vivah’s Terms do not provide a new opportunity for you to opt out of arbitration if you previously agreed to a prior version of Ved Vivah’s Terms containing an arbitration provision and did not validly opt out of arbitration.

            </li>
            <ul className="list-disc ">
              <li>Previous or existing users. Users who previously agreed to arbitrate may reject this updated Arbitration Agreement by following the opt-out method below, but such users will still be bound by the most recent prior version of the Arbitration Agreement and will otherwise be bound by these Terms. Previous or existing users who do not opt out of this updated Arbitration Agreement will be bound by this Arbitration Agreement and it shall apply to all disputes between such users and Ved Vivah, including those arising (but not actually filed in arbitration) before the effective date of these Terms. Arbitration demands that have already been actually filed with an arbitration provider before the effective date of this Arbitration Agreement and in compliance with a prior version of this Arbitration Agreement are subject to the prior version’s terms.
              </li>
              <li>
                Method and impact of opting out. Subject to the above, you may opt out of this Arbitration Agreement by sending written notice of your decision to opt out, within 31 days after first becoming subject to this Arbitration Agreement. Your notice must include your name, your Ved Vivah username (if any), the email address and/or phone number you used to set up your Ved Vivah account (if you have one), and an unequivocal statement that you want to opt out of this Arbitration Agreement. If you opt out of this Arbitration Agreement, all other parts of the Terms and any other agreements between you and Ved Vivah will continue to apply to you. Opting out of this Arbitration Agreement has no effect on any other arbitration agreements that you may currently have, or may enter in the future, with us.
            ...
            <li>
              Survival of Agreement. The terms of this Arbitration Agreement will continue, even after your relationship with Ved Vivah has ended.
          ...
          <p className="pb-4">In the event that Ved Vivah Global Services determines, in its sole discretion, that you have breached any portion of these Terms, have misused the App, or have otherwise demonstrated conduct which the Ved Vivah Global Services regards as inappropriate or unlawful (whether on or off the App), Ved Vivah Global Services reserves the right to: (a) warn you via email (to any email addresses you have provided to Ved Vivah Global Services) that you have violated the Terms; (b) delete your User Content; (c) discontinue your Account; (d) discontinue your subscription(s) without refund; (e) notify and/or send your User Content to and/or fully cooperate with the proper law enforcement authorities for further action; and/or (f) pursue to any other action which Ved Vivah Global Services deems to be appropriate. You agree that all terminations for cause shall be made in Ved Vivah Global Services’s sole discretion and that Ved Vivah Global Services shall not be liable to you or any third party for any termination of your Account.</p>
          ...
          <p className="pb-4">Termination of these Terms or your Account includes the removal of access to your Account, and all related information and content associated with or inside your Account.
            If your account is terminated by you or by the Ved Vivah Global Services for any reason, all provisions of these Terms which by their nature should survive, shall survive termination of these Terms, including, without limitation, the Arbitration Agreement, ownership provisions, warranty disclaimers and limitation of liability. Your information will be maintained and deleted in accordance with our Privacy Policy.
          </p>

          <h3 className="text-md font-bold">15. MISCELLANEOUS
          </h3>
          <p className="pb-4">There are a few more things we need to mention before you can use Ved Vivah.
            These Terms, which we may amend from time to time, constitute the entire agreement between you and the Ved Vivah Global Services. The Terms supersede all previous agreements, representations and arrangements between us (written or oral), excluding the Privacy Policy. Nothing in this clause shall limit or exclude any liability for fraudulent misrepresentation.
          </p>
          <p className="pb">
            The Ved Vivah Global Services has taken reasonable steps to ensure the currency, availability, correctness and completeness of the information contained on Ved Vivah and provides that information on an "as is", "as available" basis. The Ved Vivah Global Services does not give or make any warranty or representation of any kind about the information contained on Ved Vivah, whether express or implied. Use of Ved Vivah and the materials available on it is at your sole risk. The Ved Vivah Global Services is not responsible for any loss arising from the transmission, use of data, or inaccurate Member Content.

          </p>

          <p className="pb-4">
            You are responsible for taking all necessary precautions to ensure that any material you may obtain from Ved Vivah is free of viruses or other harmful components. You accept that Ved Vivah will not be provided uninterrupted or error free, that defects may not be corrected or that The Ved Vivah Global Services, or the server that makes it available, are free of viruses or bugs, spyware, Trojan horse or any similar malicious software. The Ved Vivah Global Services is not responsible for any damage to your computer hardware, computer software, or other equipment or technology including, but without limitation damage from any security breach or from any virus, bugs, tampering, fraud, error, omission, interruption, defect, delay in operation or transmission, computer line or network failure or any other technical or other malfunction.
            The communications between you and Ved Vivah Global Services may take place via electronic means, whether you use the App or send Ved Vivah Global Services emails, or whether Ved Vivah Global Services posts notices in the App, Site or communicates with you via email. For contractual purposes, you (a) consent to receive communications from Ved Vivah Global Services in electronic form; and (b) agree that all terms and conditions, agreements, notices, disclosures, and other communications that Ved Vivah Global Services provides to you electronically satisfy if it were to be in writing.
          </p>

          <h3 className="text-md font-bold">Changes to our Terms</h3>
          <p className="pb-4">As Ved Vivah grows, we might have to make changes to these Terms so we reserve the right to modify, amend or change the Terms at any time (a “Change”). If we do this then the Changes will be posted on this page and we will indicate the Effective Date of the updates at the bottom of the Terms. In certain circumstances, we may send an email to you notifying you of a Change. It’s also possible that we might ask you to agree to our Changes, but we’ll let you know. You should regularly check this page for notice of any Changes – we want our users to be as informed as possible.
          </p>

          <p className="pb-4">Your continued use of Ved Vivah following any Change constitutes your acceptance of the Change and you will be legally bound by the new updated Terms. If you do not accept any Changes to the Terms, you should stop using Ved Vivah immediately (uh oh, that’s going to be hard!).
          </p>
          ...
          <p className="pb-4">
            ...
            By using the App or Site, you agree and acknowledge that Ved Vivah is a global app or Site hosted on cloud service providers or through servers located overseas in a number of countries around the world, including the United States. If you live in a country with data protection laws, the storage of your personal data may not provide you with the same protections as you enjoy in your country of residence. By submitting your personal information, or by choosing to upgrade the services you use, or by making use of the applications available on Ved Vivah, you agree to the transfer of your personal information to, and storage and processing of your personal information in, any such countries and destinations.
          ...
          <p className="pb-4">Subject to Section 13(3) and any mandatory laws that may apply in the country in which you reside, your access to the App, Site, Our Content, and any Member Content, any claims arising from or related to your relationship with the Ved Vivah Global Services, and these Terms are governed and interpreted by the local laws.
          </p>

          <h3 className="text-md font-bold">17. VEDVIVAH GLOBAL SERVICES.
          </h3>

          <p >The Terms constitute a binding legal agreement between you as user (“you”) and the Ved Vivah Global Services (“we” or “us”).
          </p>
