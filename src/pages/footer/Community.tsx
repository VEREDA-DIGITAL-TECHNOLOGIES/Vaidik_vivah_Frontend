...
const Community = () => {
  ...
  <Helmet>
    ...
    <div className="flex flex-col ">
        ...
        <h1 className=" text-2xl md:text-4xl font-semibold">Ved Vivah Community Guidelines</h1>
      ...
      <div className="px-4 py-4 flex md:flex-row flex-col gap-7">
        ...
        <div className=" flex flex-col items-start md:pr-10">
          ...
          <h3 className="font-bold text-md">Ved Vivah Community Guidelines</h3>

          <p className="#475467 pb-4">
            Ved Vivah is a space to make kind connections in a safe, inclusive,
          ...
          <ul className="list-disc pl-4">
            <li className="pb-4">
              Age. You need to be at least 18 years old to join Ved Vivah.
            ...
            <li>
              ...
              Ved Vivah on your profile photos
            </li>
            <li>
          ...
          Our platform is not a
            marketplace. We don’t allow using Ved Vivah for unsolicited commercial
          ...
          <p className="pb-4">
             Ved Vivah prohibits any scam or theft activity
          ...
          <p className="pb-4">
            Safety is a top priority at Ved Vivah. We use a combination of human
            moderators and automated systems to monitor and review Ved Vivah
          ...
          <p className="pb-4">Our members play a critical role in the safety of Ved Vivah
          ...
          <p className="pb-4">All members must comply with the platform rules described and referenced in our Community Guidelines. If you behave in a way that goes against Ved Vivah’s Community Guidelines, values, or otherwise act in any way we believe to be potentially harmful to Ved Vivah or its members, we may take a range of actions on your account. When determining the penalty for violating our community guidelines, we consider a number of factors.</p>
          <p>For example, we may:</p>
          <ul className="list-disc pl-10">
            <li>Remove the content</li>
            <li>Issue a warning</li>
            <li>Ban the offending member from some or all Ved Vivah Inc. apps</li>
            ...
            <p className="pb-4">Your treatment towards others outside of the Ved Vivah app can also result in action against your account. If we’re made aware of harm between members on dates, meetups with friends, via text message or direct messaging platforms, or relevant alleged criminal or harmful conduct committed in your past or outside of Ved Vivah, we may take action as if it happened on our platform.</p>
