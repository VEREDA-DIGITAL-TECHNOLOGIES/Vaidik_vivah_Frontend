    ...
    <div className="flex flex-col ">
      ...
      <div className="flex flex-col md:flex-row flex-grow gap-5 p-4 md:p-16">
        ...
        <div className="">
          ...
          <p className="pb-4">These Cookies are necessary for the App and Websites to function and cannot be switched off in our systems, or our App and Websites will not work properly. They are usually only set in response to actions made by you which amount to a request of services, such as setting your privacy preferences, logging in or filling in forms, making payments, uploading photographs, chatting or to localise your experience, such as when you’ve requested to view Wedlock’s Site in your local language or when you’ve asked Ved Vivah to ‘remember me’, etc. You can always control the Websites’ strictly necessary Cookies in your browser, as explained below.</p>

          <h3 className="text-md font-bold">Strictly necessary Cookies</h3>
          <p className="pb-4">We also use Cookies to help keep Ved Vivah and our members safe and secure. These Cookies do things like protect Ved Vivah users from spam and fraud by ensuring the safety of your personal data when you pay for things on Ved Vivah like Wedlock’s premium services.</p>
