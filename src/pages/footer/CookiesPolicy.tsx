      ...
      <div className="flex flex-col md:flex-row flex-grow gap-5 p-4 md:p-16">
        ...
        <div className="">
          <p className="pb-4">
            ...
            technologies when you use the Ved Vivah mobile application (including
            the desktop version) (“App”) or websites (such as Ved Vivah)
          ...
          <h3 className="text-md font-bold">
            {" "}
            1. What are 'cookies' and which 'cookies' does Ved Vivah use?
          </h3>
          <p className="pb-4">
            {" "}
            ...
            recognise you and your preferences each time you visit Ved Vivah. They
          ...
          <p className="pb-4">These Cookies are necessary for the App and Websites to function and cannot be switched off in our systems, or our App and Websites will not work properly. They are usually only set in response to actions made by you which amount to a request of services, such as setting your privacy preferences, logging in or filling in forms, making payments, uploading photographs, chatting or to localise your experience, such as when you’ve requested to view Ved Vivah’s Site in your local language or when you’ve asked Ved Vivah to ‘remember me’, etc. You can always control the Websites’ strictly necessary Cookies in your browser, as explained below.</p>

          <h3 className="text-md font-bold">Strictly necessary Cookies</h3>
          <p className="pb-4">We also use Cookies to help keep Ved Vivah and our members safe and secure. These Cookies do things like protect Ved Vivah users from spam and fraud by ensuring the safety of your personal data when you pay for things on Ved Vivah like Ved Vivah’s premium services.</p>
          ...
          <p className="pb-4">Ved Vivah uses Google Analytics to collect information about how visitors use the Ved Vivah Site. We use the information to compile reports and to help us improve the Site or App. The Cookies collect information in an aggregated form, including the number of visitors to the Site or App, where visitors have come to the Site from and the pages they visited.</p>
          <p className="pb-4">These Cookies allow us to collect information about how visitors interact with our App and Websites. We use this information to compile reports and to help measure and improve the performance of the App and Websites.</p>

          <h3 className="text-md font-bold pb-4">Social Media Cookies</h3>
          <p className="pb-4">These Cookies help provide experiences, such as links to other social media Websites and social plugins, including making it easier for you to share content between Ved Vivah and your other favorite social networks.</p>
          ...
          <ul className="list-disc pl-4 pb-4">
            <li>
              in your profile settings for the Ved Vivah App (under “Settings”{" "}
