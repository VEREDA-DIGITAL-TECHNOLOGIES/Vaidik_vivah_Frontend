    ...
    <div className="flex flex-col ">
      <div className="bg-[#fac5d6]  text-center px-6 py-6 md:p-24 space-y-8">
        ...
        <p className="text-[#475467] text-md md:text-xl text-balance">
          Ved Vivah is a global matchmaking platform developed to redefine the landscape of matrimony, <br /> empowering individuals to embark on their journey towards matrimony and marital bliss with confidence and ease.
      ...
      <div className="px-4 py-4 flex md:flex-row flex-col gap-7">
        ...
        <div className=" flex flex-col items-start md:pr-10">
          <h2 className="font-bold text-xl pb-4 "> Ved Vivah Services</h2>
          <p className="pb-4">Welcome to Ved Viah - Indian’s most trusted matrimony website and mobile app comes with the feature - Ved Vivah Go, that allows members to meet up to 30 minutes over video calls.</p>

          <p className="pb-4">
            Ved Viah is becoming Indidan’s fastest growing website and mobile application to provide an exceptional matchmaking experience by expanding the opportunities available to meet potential life partners from diverse communities and nationalities.
          </p>

          <p className="pb-4">
            We at Ved Viah are committed to constantly innovating and enhancing the quality of our service to you. Based on your suggestions through the customer service desk and user research programs, we have been working on several aspects of the website, which are aimed to empower you and make your search for a life partner, fast, intuitive and easy.
          </p>
          ...
          <p className="pb-4" >
            <span className="font-semibold"> Download the app & take Ved Vivah </span> with you. With growing number of success stories, our matchmaking app has transformed the online matrimony category.
          </p>
          ...
          <p className="pb-4">We are Indian's trusted matrimony platform and our app has touched hundreds of people in Indian and in many other countries across the globe.</p>
          ...
          <h3 className="font-bold text-lg  pb-4">Register for free & create a matrimony profile on Ved Vivah</h3>
          ...
          <ul className="list-decimal pb-4 pl-4 space-y-4">
            ...
            <li>Join daily Ved Vivah Go events and meet members up to 30 minutes over video call.</li>
          </ul>
          ...
          <p className="pb-4">Such innovative technology has made Ved Vivah as one of the preferred matrimony apps across the world.</p>
          ...
          <p className="pb-4">As Indian’s trusted matrimony app which recommends right matches for you on a daily basis. Our support team also ensures that you connect with perfect profiles as per your preference.</p>
