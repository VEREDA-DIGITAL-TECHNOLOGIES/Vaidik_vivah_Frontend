...
//     const [documentupload, { isLoading: isUploading }] = useDocumentuploadMutation();
//     const { data, isLoading: isChecking } = useDocumentcheckexistsQuery();
...
//     // Check if document exists on component mount
//     useEffect(() => {
...
//                 setMessage({
//                     text: 'Error checking document status. Please refresh the page.',
//                     type: 'error',
//                 });
//             }
//         };
...
//     if (isChecking) {
//         return (
//             <div className="bg-[#FFF0F5] min-h-screen flex items-center justify-center">
//                 <div className="text-center">
//                     <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-[#FD5C90] mx-auto"></div>
//                     <p className="mt-4 text-gray-600">Checking your documents...</p>
//                 </div>
//             </div>
//         );
//     }
...
//     return (
//         <div className="bg-[#FFF0F5] min-h-screen py-8">
...
//                                 <h2 className="text-xl font-semibold text-gray-800">NDLS Verification</h2>
//                                 <button
//                                     onClick={() => handleTabSwitch('manual')}
