...
const MyDetails = () => {
  ...
  const { user, myDetails } = useSelector(
  ...
  useEffect(() => {
    if (myDetails?.toggleStatus) {
      ...
      setIsEducationFinancial(
        myDetails.toggleStatus.education_and_financial_details,
      );
  ...
  const { data: myDetailsData, isLoading: isLoading } =
    useMyDetailsQuery<any>();
  ...
  const TogglePersonalDetails = async () => {
    ...
    try {
      ...
      toast.success(
        newStatus
          ? " Personal Background is now visible."
          : "Personal Background is now hidden.",
      );
    } catch (error) {
  ...
  const ToggleReligiousDetails = async () => {
    ...
    try {
      ...
      toast.success(
        newStatus
          ? "Religious Background is now visible."
          : "Religious Background is now hidden.",
      );
    } catch (error) {
  ...
  const ToggleFamilyDetails = async () => {
    ...
    try {
      ...
      toast.success(
        newStatus
          ? "Family Background is now visible."
          : "Family Background is now hidden.",
      );
    } catch (error) {
  ...
  const ToggleEducationFinancial = async () => {
    ...
    try {
      ...
      toast.success(
        newStatus
          ? "Education Financial Background is now visible."
          : "Education Financial Background is now hidden.",
      );
    } catch (error) {
      toast.error(
        "Failed to update Education Financial Background visibility.",
      );
    }
  };
  ...
  const ToggleLocationBackground = async () => {
    ...
    try {
      ...
      toast.success(
        newStatus
          ? " Location Background is now visible. "
          : "Location Background is now hidden.",
      );
    } catch (error) {
      toast.error("Failed to update Location Background visibility.");
    }
  };
          ...
          <div className="col-span-1 xl:grid w-full md:col-span-2 gap-10">
              ...
              <div className="flex w-full flex-col  items-center justify-between gap-10 xl:flex-row">
                <div className=" xl:w-[70%] w-full ">
                  ...
                  <div className="mt-2.5  flex flex-wrap py-6 items-center gap-2.5 self-start text-base font-medium  leading-4 text-slate-900">
                    <div
                      className={`self-stretch text-xl font-bold leading-10 ${isExclusive ? "text-[#60457E]" : "text-[#FD5C90]"} lg:text-3xl`}
                    >
                        ...
                        {isEditingWhatsapp ? (
                          ...
                          <>
                            ...
                            <button
                              onClick={() => {
                                setWhatsappInput(
                                  (myDetails as any)?.whatsapp.number || "",
                                );
                ...
                <div className="h-[28rem] xl:w-[30%]  w-auto mr-4 rounded-lg bg-[#fcf2f2] text-[#FD5C90]  md:p-5 md:h-[26rem]">
                  <h2 className="font-[Bembo-MT-Pro-Bold] text-xl md:text-2xl text-center mt-2 md:text-start">
                  ...
                  <p className="text-lg font-[Bembo-MT-Pro-Regular] text-center">
                    Complete at least 50% of your profile to unlock messaging.
                    Our tip: Answer more profile questions.
                  </p>
              ...
              >
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      <Switch
                        checked={isFamilyDetails}
                        onChange={ToggleFamilyDetails}
              ...
              <div className="flex flex-col rounded-xl bg-white pb-6 shadow-sm">
                ...
                <div className="mt-6 flex flex-col px-6 max-md:px-5 xl:gap-3 ">
                  <div className="flex items-center gap-1 whitespace-nowrap">
                    <div
                      className={`text-xl leading-8 ${isExclusive ? "text-[#60457E]" : "text-[#fa4e85]"} md:text-3xl`}
                    >
                      <CiMap />
                    </div>
                  ...
                  <div
                    className={`text-md ml-8 mt-2 justify-center self-start rounded-[100px] bg-blue-50 px-3 py-1.5 text-center font-medium capitalize leading-7 ${isExclusive ? "text-[#60457E]" : "text-[#fa4e85]"} max-md:ml-2.5 md:text-md`}
                  >
                  ...
                  <div
                    className={`text-md ml-8 mt-2 flex justify-center gap-1.5 self-start rounded-[100px] border border-solid border-gray-200 bg-blue-50 bg-opacity-50 px-5 py-2 font-medium capitalize leading-7 ${isExclusive ? "text-[#60457E]" : "text-[#fa4e85]"} max-md:ml-2.5 md:py-4 md:text-md`}
                  >
                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex gap-4">
                      ...
                      <div>
                        <Switch
                          checked={isReligiousDetails}
                          onChange={ToggleReligiousDetails}
                          disabled={isToggleLoading}
                          className="custom-switch"
                        />
                      </div>
            ...
            <div className="h-auto py-4  rounded-xl mb-4 xl:mb-0 bg-white">
              ...
              >
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      <Switch
                        checked={isLocationBackground}
                        onChange={ToggleLocationBackground}
                        disabled={isToggleLoading}
                        className="custom-switch"
                      />
                    </div>
              ...
              <div className="mt-6 flex flex-col px-6 max-md:max-w-full max-md:px-5">
                ...
                <div className="mt-4 mb-4 flex justify-between gap-0 max-md:flex-wrap">
                  ...
                  <div className="justify-center self-start rounded-[100px] bg-purple-100 px-3 py-1.5 text-center text-base font-medium capitalize leading-4 tracking-normal text-violet-600">
                    {myDetails?.location_background?.state || "Not Specified"}
                  </div>
                </div>
            ...
            <div className="h-auto py-4 rounded-xl">
              <div className=" flex max-w-[499px] flex-col pb-9 leading-8 text-slate-900">
                <div
                  className={`flex items-center justify-between text-lg font-semibold leading-[110%] ${isExclusive ? "text-[#fa4e85]" : "text-[#fa4e85]"} md:text-xl`}
                >
                  Interest and hobbies
                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex gap-4">
                      ...
                      <div>
                        <Switch
                          checked={isEducationFinancial}
                          onChange={ToggleEducationFinancial}
                          disabled={isToggleLoading}
                          className="custom-switch"
                        />
                      </div>
                ...
                <div className="mt-6 flex flex-col px-6 max-md:px-5">
                  <div className="flex justify-between gap-2 whitespace-nowrap pr-8 max-md:pr-5">
                    <div className="text-md flex items-center justify-between gap-2 self-start leading-8 tracking-wide text-slate-600 md:text-xl">
                      <span
                        className={`${isExclusive ? "text-[#60457E]" : "text-[#fa4e85]"}`}
                      >
                        <FaUserGraduate />
                      </span>
