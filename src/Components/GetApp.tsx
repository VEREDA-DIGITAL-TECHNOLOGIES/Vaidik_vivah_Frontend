        ...
        <div className="bg-container flex flex-col lg:flex-row justify-between w-full px-6 md:px-16 py-8 md:py-12">
          <div className="flex flex-col space-y-12 lg:space-y-32 ml-4 md:ml-20 w-full lg:w-1/2">
            ...
            <div className="flex flex-row    lg:space-x-5 space-y-1  sm:space-y-0" >
              <button className="rounded-2xl bg-[#FFFFFF] border-2 border-[#0000004D] text-black text-lg p-3 cursor-pointer px-5">
              ...
              <button className="rounded-2xl bg-[#FFFFFF] border-2 border-[#0000004D] text-black text-lg p-3 px-5">
          ...
          <div className="relative ">
            <Image src="/qr.svg" width={200} height={200} alt="QR code" className="absolute w-[150px] sm:w-[200px] lg:w-[250px] -right-20 md:-right-24 lg:-left-24 bottom-0 lg:bottom-20 transform -translate-x-[25%] -translate-y-[50%]" />
            <Image src="/ph.svg" width={150} height={300} alt="Phone" className="w-[120px] sm:w-[150px] lg:w-[200px]" />
          </div>
          </div>
