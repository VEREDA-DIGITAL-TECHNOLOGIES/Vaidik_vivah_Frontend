  ...
  const onSubmit: SubmitHandler<FormData> = async (data) => {
    try {
      ...
      if (successData.success === true) {
        ...
        const isQualificationFormFilled =
          successData?.user?.isQualificationFormFilled;
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-opacity-50">
      <div className="bg-gradient-to-t from-[#FD5C90] to-[#f78aad] p-6 rounded-lg w-full max-w-md relative sm:rounded-2xl sm:p-8 overflow-y-auto max-h-[90vh]">
        ...
        {/* Heading */}
        <h2 className="text-2xl font-[Bembo-MT-Pro-Bold] text-center mb-4">
          Login
        </h2>
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <button
            ...
            className="border w-full h-12 mt-3 rounded-md text-white flex items-center justify-center gap-2 hover:bg-white/10 transition"
          >
            <img
